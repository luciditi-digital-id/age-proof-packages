Pod::Spec.new do |spec|
    ...
    spec.version                  = '1.0.6-beta.3523'
    spec.homepage                 = 'https://github.com/luciditi-digital-id/age-proof-packages'
    spec.source                   = { :http => 'https://github.com/luciditi-digital-id/age-proof-packages/releases/download/presence-v1.0.6-beta.3523/ageProofPresence.xcframework.zip' }
