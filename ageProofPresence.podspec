Pod::Spec.new do |spec|
    ...
    spec.version                  = '1.1.0-beta.3611'
    spec.homepage                 = 'https://github.com/luciditi-digital-id/age-proof-packages'
    spec.source                   = { :http => 'https://github.com/luciditi-digital-id/age-proof-packages/releases/download/presence-v1.1.0-beta.3611/ageProofPresence.xcframework.zip' }
